...
export const metadata: Metadata = {
  title: "Numerology Tool",
  description: "Life path and name-number insights — launching soon on VedGuide.",
};

export default function NumerologyToolPage() {
  return (
    <div className="mx-auto max-w-2xl px-4 py-14 sm:py-20">
      ...
      <p className="mx-auto mt-3 max-w-md text-center text-[15px] leading-relaxed text-muted-foreground">
        We are building a quick numerology calculator (life path, destiny number, and name
        vibration) that matches VedGuide&apos;s Vedic style.
      </p>
      <div className="mt-10 rounded-2xl border border-dashed border-border bg-muted/30 px-6 py-10 text-center">
        <p className="text-sm text-muted-foreground">
          Until this ships, your birth chart already encodes deep timing — start with a free kundli
          or order a full personalized report.
        </p>
