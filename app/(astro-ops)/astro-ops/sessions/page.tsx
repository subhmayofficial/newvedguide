...
import { healStuckOpenChatsWithEmptyWallet } from "@/lib/chat/sync-open-chat-for-wallet";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-start justify-between gap-4">
        ...
        <Link href="/astro-ops" className="flex items-center gap-1 text-sm font-semibold text-brand hover:underline">
          ...
          <tbody className="divide-y divide-border/40">
            {list.map((s) => (
              ...
              >
                ...
                <td className="px-4 py-3">
                  <Link
                    href={`/astro-ops/users/${s.user_id}`}
