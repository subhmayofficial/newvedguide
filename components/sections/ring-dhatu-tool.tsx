...
import { RASHI_DHATU } from "@/lib/ring-dhatu";
...
type RingDhatuToolVariant = "default" | "astro";

type RingDhatuToolProps = {
  freeKundliHref?: string;
  variant?: RingDhatuToolVariant;
  idPrefix?: string;
};
...
const TOOL_COPY: Record<RingDhatuToolVariant, ToolCopy> = {
  default: {
    introTitle: "Apna sahi ring metal jaanen",
    introBody1:
    ...
    introBody2:
      "Ring metal ke fayde: positive energy, mental clarity, aur grah alignment.",
  ...
  astro: {
    introTitle: "Ring metal quick match",
    introBody1:
                ...
                <div className="relative mt-4 overflow-hidden rounded-3xl border-2 border-red-500/80 bg-gradient-to-br from-red-950 via-red-900 to-red-800 px-3 py-3.5 shadow-[0_20px_48px_-20px_rgba(127,29,29,0.7)] sm:px-4 sm:py-4">
                  ...
                  <div className="relative mt-2.5 overflow-hidden rounded-2xl border-2 border-red-200/45 bg-black shadow-2xl -mx-3 sm:-mx-4">
                    <div className="relative aspect-[16/10] overflow-hidden">
                      <iframe
                        src={RING_DHATU_IMPORTANT_VIDEO_URL}
                        title="Very important ring dhatu video"
